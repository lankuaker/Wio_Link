...
void rpc_server_register_resources()
{
    ...
    //GroveAccMMA76601
    GroveAccMMA7660 *GroveAccMMA76601_ins = new GroveAccMMA7660(4,5);
    memset(arg_types, TYPE_NONE, MAX_INPUT_ARG_LEN);
    rpc_server_register_method("GroveAccMMA76601", "accelerometer", METHOD_READ, __grove_acc_mma7660_read_accelerometer, GroveAccMMA76601_ins, arg_types);
    memset(arg_types, TYPE_NONE, MAX_INPUT_ARG_LEN);
    rpc_server_register_method("GroveAccMMA76601", "shacked", METHOD_READ, __grove_acc_mma7660_read_shacked, GroveAccMMA76601_ins, arg_types);
...
void print_well_known()
{
    ...
    writer_print(TYPE_STRING, "\"GET " OTA_SERVER_URL_PREFIX "/Grove_Example1/temp -> int : temp\",");
    writer_print(TYPE_STRING, "\"GET " OTA_SERVER_URL_PREFIX "/Grove_Example1/uint8_value -> uint8_t : value\",");
    writer_print(TYPE_STRING, "\"GET " OTA_SERVER_URL_PREFIX "/Grove_Example1/with_arg/int_arg -> float : cx, float : cy, float : cz, int : degree\",");
    writer_print(TYPE_STRING, "\"GET " OTA_SERVER_URL_PREFIX "/Grove_Example1/compass -> float : cx, float : cy, float : cz, int : degree\",");
    writer_print(TYPE_STRING, "\"GET " OTA_SERVER_URL_PREFIX "/Grove_Example1/acc -> float : ax, float : ay, float : az\",");
    writer_print(TYPE_STRING, "\"GET " OTA_SERVER_URL_PREFIX "/Grove_Example1/humidity -> float : humidity\",");
    writer_print(TYPE_STRING, "\"POST " OTA_SERVER_URL_PREFIX "/Grove_Example1/multi_value/int_a/float_b/uint32_t_c\",");
    writer_print(TYPE_STRING, "\"POST " OTA_SERVER_URL_PREFIX "/Grove_Example1/acc_mode/uint8_t_mode\",");
    writer_print(TYPE_STRING, "\"POST " OTA_SERVER_URL_PREFIX "/Grove_Example1/float_value/float_f\",");
    writer_print(TYPE_STRING, "\"POST " OTA_SERVER_URL_PREFIX "/GroveRelay/onoff/int_onoff\",");
    writer_print(TYPE_STRING, "\"GET " OTA_SERVER_URL_PREFIX "/GroveAccMMA76601/accelerometer -> float : ax, float : ay, float : az\",");
    writer_print(TYPE_STRING, "\"GET " OTA_SERVER_URL_PREFIX "/GroveAccMMA76601/shacked -> uint8_t : shacked\"");
    writer_print(TYPE_STRING, "]");
}
